...
public class HighLevelConsumerTest {
	private String topic = "sohuwl-pv";
	...
	public void init() {
		...
		props.put("zookeeper.connect",
				"10.16.10.76:2181,10.16.10.94:2181,10.16.10.99:2181/kafka-0.8.1");
		props.put("zookeeper.connection.timeout.ms", "20000");
		props.put("serializer.class", "kafka.serializer.StringEncoder");
		props.put("group.id", "big-rec-test");
	...
	public void consume() {
		try {
			...
			while (iter.hasNext()) {
				MessageAndMetadata<byte[], byte[]> messageAndMetadata = iter
						.next();
	...
	private String getMessage(
		...
		try {
			...
			logger.error("[ERROR-getMessage]messageAndMetadata="
					+ messageAndMetadata, e);
		}
		return res;
